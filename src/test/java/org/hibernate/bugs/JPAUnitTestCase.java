...
public class JPAUnitTestCase {
    ...
    private static final String SELECT_QUERY = """
             select a from Student a where (:firstname is null or a.firstName in :firstname)
            """;
    ...
    public void nativeQueryExample() {
        ...
        try {
            ...
            query.setParameter("firstname", List.of("qwerty", "qwerty1"));
    ...
    public void queryExample() {
        ...
        try {
            var query = entityManager.createQuery(SELECT_QUERY);
            query.setParameter("firstname", List.of("qwerty", "qwerty1"));
            var resultList = query.getResultList();
